...
import { getPreSheetById, listEnabledSettleItems } from '@/api/business/settle';
...
const PreSheetDetail: React.FC = () => {
    ...
    const detailColumns = [
        ...
        { title: '收支项目', dataIndex: 'itemId', render: (id: number) => getItemName(id) },
        { title: '金额', dataIndex: 'amount', render: (val: number) => `￥${val?.toFixed(2) || '0.00'}` },
    ];

    return (
        <div style={{ padding: '24px' }}>
            <Card title="供应商预付款单详情" extra={<Button icon={<ArrowLeftOutlined />} onClick={() => navigate('/business/settle/pre')}>返回</Button>}>
                <Spin spinning={loading}>
                    ...
                    <Card title="预付款明细" size="small" style={{ marginTop: 24 }}>
